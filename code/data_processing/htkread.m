...
% open file and store in memory using big endian format, i.e the most
% significant bit is stored first in the memory, Hence 'r' = read,
% 'ieee-be' = big endian notation
