...
% uses statistics in dataList to train the i-vector extractor with tv_dim 
...
S = reshape(ubm.sigma, ndim * nmix, 1); % reshape sigma as 102x8 and arranging it in 816x1 form
