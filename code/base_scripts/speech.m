%% I-Vector Extraction Code for speech signals
...
for i = 1: length(dpath)
    ...
    combo = [EE E Z R C F mfcc lpcs lpccs rcs lars lsfs sscs formants...
        jitter_local jitter_local_absolute jitter_RAP jitter_PPQ5 shimmer_rel...
        shimmer_local_absolute shimmer_APQ3 shimmer_APQ5];  % combo_dys = 90x51
    
%     combo = [Z C mfcc lpcs lpccs rcs lars lsfs formants jitter_local jitter_local_absolute jitter_RAP jitter_PPQ5 shimmer_rel...
%         shimmer_local_absolute shimmer_APQ3 shimmer_APQ5];
