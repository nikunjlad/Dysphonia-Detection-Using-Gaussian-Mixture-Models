function varargout = IvecGui(varargin)
% IVECGUI MATLAB code for IvecGui.fig
%      IVECGUI, by itself, creates a new IVECGUI or raises the existing
%      singleton*.
%
%      H = IVECGUI returns the handle to a new IVECGUI or the handle to
%      the existing singleton*.
%
%      IVECGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IVECGUI.M with the given input arguments.
%
%      IVECGUI('Property','Value',...) creates a new IVECGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before IvecGui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to IvecGui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help IvecGui

% Last Modified by GUIDE v2.5 23-Jul-2017 06:27:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @IvecGui_OpeningFcn, ...
                   'gui_OutputFcn',  @IvecGui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before IvecGui is made visible.
function IvecGui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to IvecGui (see VARARGIN)

% Choose default command line output for IvecGui
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes IvecGui wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = IvecGui_OutputFcn(hObject, eventdata, handles) 
...
msgbox('Audio files loaded successfully','Success');
...
for i = 1: length(dpath)
    ...
    [jitter_local,jitter_local_absolute,jitter_RAP,jitter_PPQ5,shimmer_rel,...
        shimmer_local_absolute,shimmer_APQ3,shimmer_APQ5,~]=JitterShimmer(s,fs);
...
msgbox('PF saved and speech features extracted successfully!','success');
...
devIVs = i_vector(PF);
msgbox('I-Vector extracted','success');
...
msgbox('Data arranged for classification','success');
...
[acc,TP,FP,precision,TPR,TNR,FAR,FRR,Fmeasure,~] = results(labeltr,ytr,'Training',0);

set(handles.edit10,'String',num2str(acc));
set(handles.edit11,'String',num2str(TP));
set(handles.edit12,'String',num2str(FP));
set(handles.edit13,'String',num2str(precision));
set(handles.edit14,'String',num2str(TPR));
set(handles.edit15,'String',num2str(TNR));
set(handles.edit16,'String',num2str(FAR));
set(handles.edit17,'String',num2str(FRR));
set(handles.edit18,'String',num2str(Fmeasure));

%% Performance parameters for cross validating data

fprintf('\n--------------- Cross Validation Data ---------------\n');
[labelcv,~] = predict(SVMModel,Xcv);
[acc,TP,FP,precision,TPR,TNR,FAR,FRR,Fmeasure,~] = results(labelcv,ycv,'CV',0);

set(handles.edit28,'String',num2str(acc));
set(handles.edit29,'String',num2str(TP));
set(handles.edit30,'String',num2str(FP));
set(handles.edit31,'String',num2str(precision));
set(handles.edit32,'String',num2str(TPR));
set(handles.edit33,'String',num2str(TNR));
set(handles.edit34,'String',num2str(FAR));
set(handles.edit35,'String',num2str(FRR));
set(handles.edit36,'String',num2str(Fmeasure));
  
%% Performance parameters for testing data

fprintf('\n--------------- Testing Data ---------------\n');
labeltst = predict(SVMModel,Xtst);
[acc,TP,FP,precision,TPR,TNR,FAR,FRR,Fmeasure,~] = results(labeltst,ytst,'Testing',0);

set(handles.edit63,'String',num2str(acc));
set(handles.edit62,'String',num2str(TP));
set(handles.edit61,'String',num2str(FP));
set(handles.edit60,'String',num2str(precision));
set(handles.edit59,'String',num2str(TPR));
set(handles.edit58,'String',num2str(TNR));
set(handles.edit57,'String',num2str(FAR));
set(handles.edit56,'String',num2str(FRR));
set(handles.edit55,'String',num2str(Fmeasure));
...
[acc,TP,FP,precision,TPR,TNR,FAR,FRR,Fmeasure,AUC] = results(labeltt,y,'Total',1);

set(handles.edit64,'String',num2str(acc));
set(handles.edit65,'String',num2str(TP));
set(handles.edit66,'String',num2str(FP));
set(handles.edit67,'String',num2str(precision));
set(handles.edit68,'String',num2str(TPR));
set(handles.edit69,'String',num2str(TNR));
set(handles.edit70,'String',num2str(FAR));
set(handles.edit71,'String',num2str(FRR));
set(handles.edit72,'String',num2str(Fmeasure));
set(handles.edit73,'String',num2str(AUC));
...
%% SVM with i-vectors and finding optimal parameters
...
bc = SVMModel.ModelParameters.BoxConstraint;
kc = SVMModel.ModelParameters.KernelScale;
fprintf('Optimized Parameters: BoxConstraint = %f, KernelScale = %f',bc,kc);
msgbox('Optimzation Completed','success');
...
function edit66_Callback(hObject, ~, handles)
...
function edit69_Callback(hObject, eventdata, ~)
...
function edit71_Callback(hObject, eventdata, ~)
...
% --- Executes during object creation, after setting all properties.
function edit72_CreateFcn(hObject, ~, handles)
% hObject    handle to edit72 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit62_Callback(hObject, ~, handles)
...
function edit60_Callback(~, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function edit59_CreateFcn(hObject, ~, handles)
% hObject    handle to edit59 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function edit57_CreateFcn(hObject, ~, handles)
% hObject    handle to edit57 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit55_Callback(~, eventdata, ~)
...
% --- Executes during object creation, after setting all properties.
function edit55_CreateFcn(hObject, ~, ~)
% hObject    handle to edit55 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit36_Callback(~, eventdata, ~)
...
% --- Executes during object creation, after setting all properties.
function edit36_CreateFcn(hObject, ~, ~)
% hObject    handle to edit36 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function edit35_CreateFcn(hObject, ~, handles)
% hObject    handle to edit35 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit34_Callback(hObject, ~, handles)
...
% --- Executes during object creation, after setting all properties.
function edit33_CreateFcn(hObject, ~, handles)
% hObject    handle to edit33 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit30_Callback(hObject, ~, handles)
...
function edit28_Callback(hObject, ~, handles)
